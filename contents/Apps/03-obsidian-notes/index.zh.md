...
>[!TIP]
>
> 本教程假设你知道怎么打开终端、运行基本命令。如果听起来有点慌，先花5分钟看看 [Terminal 基础](../../../Basic-tools/01-terminal-basics) 和 [Homebrew 安装](../../../Basic-tools/05-homebrew-install)，绝对物超所值。
...
>[!NOTE]
>
> 为避免权限不足的问题，建议选择 `Run as Administrator` 打开 PowerShell。
...
>[!NOTE]
>
> 虽然 Obsidian 允许你通过 **File → Open Vault** 切换库，但通常建议使用单一库，以便更好地利用其笔记管理功能。此外，Obsidian 无法和 Office 系列一样通过右键打开单一 .md 文件。
...
>[!TIP]
>
> 在 Obsidian 中，你创建的文件默认是 **Markdown 文件**。当你输入内容时，Obsidian 会实时渲染 Markdown 语法并显示格式化的预览效果。
