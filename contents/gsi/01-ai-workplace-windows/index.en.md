---
title: Set Up Your AI Workspace (Windows)
draft: false
prev: Basic-tools/06-git-basis
next: gsi/02-claude-code-vscode
---
# Set Up Your AI Workspace (Windows)
...
![](images/Pasted%20image%2020260330175936.png)

Double-click the installer and follow the wizard.

![](images/Pasted%20image%2020260330163950.png)

![](images/Pasted%20image%2020260330180107.png)

![](images/Pasted%20image%2020260330180121.png)

![](images/Pasted%20image%2020260330180133.png)

![](images/Pasted%20image%2020260330180145.png)

When installation finishes, press **Win**, search for **Visual Studio Code** or **Code**, and open it.

![](images/Pasted%20image%2020260330180239.png)
...
![691](images/01-vscode-usage-20260305172317.jpg)
...
Right-click → **Rename**, type the new name. On Windows you can also select the file and press **F2**.

> [!TIP]
>
> If **Rename** does not appear, make sure you are not in a read-only view, or use the rename entry from the context menu.

![](images/Pasted%20image%2020260330180417.png)
#### Rename a folder

Same as files: **Rename**, or select and press **F2**.
...
To start a new session, use **New Session** in the panel or the Claude Code icon in the editor title bar.
...
![](images/Pasted%20image%2020260331102312.png)

To show hidden files in File Explorer: **…** (More) → **Options**.

![](images/Pasted%20image%2020260331102506.png)

Open the **View** tab, under **Hidden files and folders** choose **Show hidden files, folders, and drives**.

![](images/Pasted%20image%2020260331102608.png)

Click **Apply** and **OK** to save; the profile folder will list hidden items too.

![](images/Pasted%20image%2020260331102742.png)

---

## Part 4: CLI Claude Code (optional)

Press **Win**, search for **PowerShell**, and open it (use **Run as administrator** if a component install needs elevation).

![](images/Pasted%20image%2020260331102917.png)

Run the command below and press **Enter**. When `winget` finishes, the CLI coding assistant is installed (it can coexist with the VS Code extension).

```powershell
winget install Anthropic.ClaudeCode
```

![](images/Pasted%20image%2020260331103058.png)

![](images/Pasted%20image%2020260331103256.png)
