...
>[!TIP]
>
> Spotlight 会学习你的使用习惯。你用得越多，它就越聪明，越能预测你要找什么。
...
>[!WARNING]
>
> **开发者必读**：默认情况下，macOS 隐藏文件扩展名和系统文件。当你处理 `.gitignore`、`.env`、`.zshrc` 时，你需要看到这些。
...
>[!TIP]
>
> 以点开头的文件（如 `.gitignore`）在基于 Unix 的系统中默认是隐藏的。这个快捷键是你最好的朋友。
...
>[!TIP]
>
> 花 5 分钟在 System Settings → Trackpad 里探索所有手势。肌肉记忆以后会感谢你的。
