...
- ✅ Claude Code installed (see [Claude Code Usage Guide](04-claude-codel.html) for installation instructions)
  Claude Code 已安装（安装说明请参见 [Claude Code 使用教程](04-claude-codel.html)）
